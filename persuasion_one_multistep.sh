...
run_script() {
    ...
    if [[ "$model" == "meta-llama/Llama-3.3-70B-Instruct-Turbo" ]]; then
        output_file="Llama-3_3_70B_instruct_turbo/results/$parent_dir/PCoT_One_MultiStep/persuasion_and_explanation.csv"
    else
        output_file="gpt4o-mini/results/$parent_dir/PCoT_One_MultiStep/persuasion_and_explanation.csv"
    fi
