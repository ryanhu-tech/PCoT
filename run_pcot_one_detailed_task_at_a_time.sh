...
#            "gpt4o-mini/results/Infotester4Education/PCoT_One_Detailed_Task_At_a_Time/"
        ...
        declare -a datasets=(
#            "Llama-3_3_70B_instruct_turbo/results/CoAID/PCoT_One_Detailed_Task_At_a_Time/"
#            "Llama-3_3_70B_instruct_turbo/results/FakeNewsNet/PCoT_One_Detailed_Task_At_a_Time/"
#            "Llama-3_3_70B_instruct_turbo/results/ISOTFakeNews/PCoT_One_Detailed_Task_At_a_Time/"
#            "Llama-3_3_70B_instruct_turbo/results/F3_LLM/PCoT_One_Detailed_Task_At_a_Time/"
#            "Llama-3_3_70B_instruct_turbo/results/F3_LLM_Minor/PCoT_One_Detailed_Task_At_a_Time/"
#            "Llama-3_3_70B_instruct_turbo/results/F3_LLM_Major/PCoT_One_Detailed_Task_At_a_Time/"
#            "Llama-3_3_70B_instruct_turbo/results/F3_LLM_Critical/PCoT_One_Detailed_Task_At_a_Time/"
            "Llama-3_3_70B_instruct_turbo/results/Infotester4Education/PCoT_One_Detailed_Task_At_a_Time/"
        )
    fi
...
run_script() {
    ...
    if [[ "$model" == "meta-llama/Llama-3.3-70B-Instruct-Turbo" ]]; then
        output_file="$parent_dir/PCoT_One_Detailed_Task_At_a_Time/$prompt_type/final.csv"
    else
        output_file="$parent_dir/PCoT_One_Detailed_Task_At_a_Time/$prompt_type/final.csv"
    fi
